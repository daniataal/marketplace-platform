...
**TRANSACTION CODE: CIF-FG-UAE-{DATE}-{DEAL_ID}**

This Sales Purchase Agreement (SPA) is made and entered into on **{DATE}**, by and between:

### SELLER:
**Company Name:** {SELLER_NAME}
**Business Address:** {SELLER_ADDRESS}
**Trade Licence No.:** {SELLER_LICENSE}
**Represented By:** {SELLER_REP}
**Passport Number:** {SELLER_PASSPORT}
**Passport Expiration:** {SELLER_PASSPORT_EXPIRY}
**Country:** {SELLER_COUNTRY}
**Telephone:** {SELLER_PHONE}
**Email:** {SELLER_EMAIL}
(Hereinafter referred to as “THE SELLER” or “FG”)
...
**Trade Licence No.:** {BUYER_LICENSE}
**Represented By:** {BUYER_REP}
**Passport Number:** {BUYER_PASSPORT}
...
*   **Form:** Gold Dore Bars
*   **Purity:** +96% ({PURITY} in final product)
*   **Finesse:** +23 Carats
*   **Age:** New
*   **Product Origin:** Uganda
*   **Port of Origin:** Kampala
*   **Port of Delivery:** DXB – Dubai International Airport (Free Zone)
*   **Final Destination:** Buyers designated accredited refinery in Dubai
*   **Quantity:** {QUANTITY} kg
*   **Contract:** Spot purchase, with extensions as agreed between Parties
...
3.1 **Terms (INCOTERMS 2020 all subsequent amendments) and Location:** CIF DUBAI, UNITED ARAB EMIRATES (DXB) - {DELIVERY_LOCATION}
3.2 Buyer, Consignee, DXB: {BUYER_NAME}
3.3 Importing Customs Agent DXB: [(Name, Address, Contact person...)]
3.4 Transport Company UAE: [(Name, Address...)]
3.5 UAE Refinery UAE: [(Name, Address...)]
...
e) The Seller shall notify the Buyer of the cargo’s arrival and be fully responsible for instructing the transfer of the cargo to the refinery on the same day if the notification is received before 15:00. If received after 15:00, the transfer must occur on the next working day before midday.
...
f) The Seller may have its representative(s) present during the weighing, assaying, refining, and establishment of the out-turn results at the Buyers designated refinery.
g) The Seller will issue the invoice based on the refinery’s out-turn results as established in Article 6.
h) The Buyer will make the bank wire transfer payment of the price specified under Article 6 to the Seller’s account no later than two (2) banking days after receiving the assay report from the gold assay laboratory.
...
#### Article 17 – Successors and Assignments
...
#### Article 21 - Variations and Waiver
...
1- Incorporate U.S. Public Law 106-229, ‘‘Electronic Signatures in Global and National Commerce Act’’ or such other applicable law conforming to the UNCITRAL Model Law on Electronic Signatures (2001)
