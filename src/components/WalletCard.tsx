...
export function WalletCard({ initialData }: { initialData: WalletData }) {
    ...
    return (
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
            {/* Background Effects */}
            ...
            <div className="relative z-10">
                <div className="flex items-start justify-between mb-8">
                    <div className="space-y-1">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-white tracking-tight tabular-nums">
                            ${totalValue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </h2>
                    </div>
                    <div className="p-4 bg-zinc-800/80 backdrop-blur-md rounded-2xl border border-white/5 text-primary shadow-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-5 rounded-2xl bg-zinc-800/40 border border-white/5 hover:bg-zinc-800/60 transition-colors group/card">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wide">Available Balance</span>
                        </div>
                    ...
                    <div className="p-5 rounded-2xl bg-zinc-800/40 border border-white/5 hover:bg-zinc-800/60 transition-colors group/card">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wide">Portfolio Value</span>
                        </div>
                        <p className="text-xl font-bold text-white tabular-nums">
